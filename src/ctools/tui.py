...
from ctools.scanner import CATEGORIES, Resource, group_by_category, scan_all
...
class DetailPanel(Static):
    ...
    def show_legend(self) -> None:
        ...
        legend = Text()
        legend.append("ctools — Resource Explorer\n\n", style="bold cyan")
...
class CtoolsApp(App[int]):
    """Main Textual application for ctools."""

    TITLE = "ctools — Claude Code Tools Explorer"
    CSS = """
    #body {
        height: 1fr;
        layout: horizontal;
