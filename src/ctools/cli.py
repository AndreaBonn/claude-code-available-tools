...
from ctools import inline, terminal
...
def _launch_external(args: argparse.Namespace) -> int:
    """Spawn a new terminal window running ctools in TUI mode."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.mode == "tui":
        from ctools import tui  # lazy import — keeps startup fast when not needed
